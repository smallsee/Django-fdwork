...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(max_length=30, verbose_name=u'验证码类型', choices=(('register', u'注册'), ('forget', u'忘记密码'), ('update_email', u'修改邮箱')))
...
class Banner(models.Model):
    ...
    image = models.ImageField(upload_to="banner/%Y/%m", verbose_name=u'轮播图', default=u'image/default')
